...
def initialize(){
    ...
    switch(settings.frequency) { 
        case 1: runEvery1Minute(getstatus) ; sendEvent(name: "poll", value: "1️⃣", displayed:false) ;break;
        case 5: runEvery5Minutes(getstatus) ; sendEvent(name: "poll", value: "5️⃣", displayed:false) ; break;
        case 10: runEvery10Minutes(getstatus) ; sendEvent(name: "poll", value: "🔟", displayed:false) ; break;
        default: runEvery10Minutes(getstatus) ; sendEvent(name: "poll", value: "5️⃣", displayed:false) ;break;
    } 
    getstatus()
}
...
def updateDeviceNetworkID() {
    ...
    sendEvent(name: "dni", value: "🖥️ DNI:${device.deviceNetworkId}${newline}", displayed:false)
}
